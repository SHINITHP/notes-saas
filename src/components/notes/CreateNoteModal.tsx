...
export function CreateNoteModal({ open, onOpenChange, onSave }: CreateNoteModalProps) {
  const form = useForm({
      ...
      <DialogContent className="max-w-2xl dark:bg-[#1a1a1a] animate-fade-in border border-border shadow-glow animate-scale-in">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            Add a new note to your collection. Use tags to organize and find your notes easily.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
